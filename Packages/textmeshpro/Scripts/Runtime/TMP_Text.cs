...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        public TMP_Text() {
            ...
            //m_input_CharArray = new char[256];
            ...
            //m_styleStack = new TMP_RichTextTagStack<int>(new int[16]);
            m_TextStyleStacks = new TMP_TextProcessingStack<int>[8];
        ...
        protected static MaterialReference[] m_materialReferences = new MaterialReference[32];
